...
public class ElevationDragFragment extends Fragment {
    ...
    private ViewOutlineProvider mOutlineCircleProvider;
    private ViewOutlineProvider mOutlineRectProvider;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        floatingShape.setOutlineProvider(mOutlineCircleProvider);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    case 0:
                        ...
                        break;
                    case 1:
                        floatingShape.setOutlineProvider(mOutlineRectProvider);
    ...
    private void createOutlines() {
       ...
       final int shapeSize = getResources().getDimensionPixelSize(R.dimen.shape_size);
        ...
        mOutlineCircleProvider=new ViewOutlineProvider() {
            @Override
        ...
        mOutlineRectProvider=new ViewOutlineProvider() {
            @Override
            public void getOutline(View view, Outline outline) {
